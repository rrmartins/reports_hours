defmodule ReportsHours do
  ...
  @available_person [
    :rodrigo, :natali, :rafael, :diego, :daniele, :mayk, :jakeliny, :giuliano, :joseph, :cleiton, :vinicius, :danilo
  ]
  ...
  defp sum_values([person, hour, _day, month, year], %{"all_hours" => hours, "hours_per_month" => months, "hours_per_year" => years}) do
    person = String.downcase(person)
             |> String.to_atom()
